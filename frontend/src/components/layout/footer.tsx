...
const navigation = {
  ...
  social: [
    {
      name: 'Twitter',
      href: 'https://twitter.com/debattle',
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/debattle',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <footer className="bg-white dark:bg-secondary-900">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-12 sm:py-16 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-secondary-500 dark:text-secondary-400">
          &copy; {new Date().getFullYear()} Debattle. All rights reserved.
        </p>
      </div>
    </footer>
  )
