              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="block w-full appearance-none rounded-md border border-secondary-300 px-3 py-2 shadow-sm placeholder:text-secondary-400 focus:border-primary-500 focus:outline-none focus:ring-primary-500 dark:border-secondary-700 dark:bg-secondary-800 dark:text-white dark:placeholder:text-secondary-500 sm:text-sm"
                  />
                </div>
              </div>
